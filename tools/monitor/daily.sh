...
#   출력 : daily_summary.tsv · daily_spectra.root · 32..40_*.png  (32 라이브타임 · 33/34 후보/일 · 35/36 rate · 37~40 스펙트럼)
#   컷은 metrics.sh 와 같은 monitorcuts.params 키를 읽는다 (mu_shower_npe · lihe_* · fn_e_*_mev).
# ---------------------------------------------------------------------
set -u
...
ARGS="\"$OUT/\", $MU, $LLO, $LHI, $LMIN, $FLO, $FHI, $LFR"
echo "날짜별 : $OUT/daily_summary.tsv · daily_spectra.root · 32..40_*.png   (컷 $CUTS)"
