...
우리 것    22개.  런 4280 이상  +  되메운 4208 4209 4210 4211 4276
```

우리가 쓴 22개 : 4208 4209 4210 4211 4276 4280 4282 4283 4284 4285 4286 4287
4288 4289 4290 4291 4292 4293 4294 4300 4301 4302.
...
- truncated_tail 16개(2466~3923) 격리. 사용자 판단 대기
- `prd_gap` 24개 재처리. 원본이 멀쩡하므로 postrun 을 다시 돌리면 된다
...
지금은 4294 백업 중이라 재시작하지 않았다. 한가할 때 §11.38 처럼
`C-c` 후 재실행할 것.
