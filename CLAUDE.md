...
우리 것    26개.  런 4280 이상  +  되메운 4208 4209 4210 4211 4276
```

우리가 쓴 26개 : 4208 4209 4210 4211 4276 4280 4282 4283 4284 4285 4286 4287
4288 4289 4290 4291 4292 4293 4294 4300 4301 4302 4303 4304 4305 4306.
...
```
1  영광 사이트의 인터넷 회선 계약 대역이 얼마인가        145 Mbps 라면 그게 답이다
2  중간 방화벽·셰이퍼에 속도 제한이 걸려 있는가
3  KREONET 접속 회선의 대역은 얼마인가                   백본은 10~100 Gb 다
...
- **경희대 백업 경로가 145 Mbps 에서 막혀 있다** (§11.121). 이 PC 의 1 Gb 카드는
  13%만 쓰인다 — **랜카드 교체는 값어치가 없고**, 사이트 회선·셰이퍼를 확인해야 한다.
  경로가 1 Gb 를 내주기만 해도 백업이 3.9시간에서 33분이 된다
