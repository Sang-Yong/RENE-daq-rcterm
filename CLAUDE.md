...
2026-06 (4237)     4.3만 (28 %) / 0 ★스키마 1              3.3만 (15 %) / 4.9천 (5 %)
...
③ ★ dst/ 의 4237 은 **스키마 1(T_Sat 없음)** 이라 6 월의 '미태그 포화 뮤온' 이 빠져 있어 >20k 100 % 는 가짜다 — `/Data_ssd/LOG/dst4237-rebuild.sh` 로
파형부터 다시 만들고(캐시 `cache.schema1-4237/` 로 치움, ~10 h) 끝나면 dst 벌을 다시 그린다. dst_m2 벌은 온전하다.
