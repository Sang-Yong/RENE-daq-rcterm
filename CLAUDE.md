...
scripts/swap-logdir.sh   postrun 로그 디렉터리를 새것으로 갈아끼운다 (§11.101)
...
우리 것    24개.  런 4280 이상  +  되메운 4208 4209 4210 4211 4276
```

우리가 쓴 25개 : 4208 4209 4210 4211 4276 4280 4282 4283 4284 4285 4286 4287
4288 4289 4290 4291 4292 4293 4294 4300 4301 4302 4303 4304 4305.
...
교체는 **로테이션(4306 -> 4307, 06:14경)에** 한다. 서브런 0 은 carry 가
`(0,0,0)` 이라 옛 로그가 필요 없어 가장 깔끔하다. 안전 게이트가 서브런 30 을
넘으면 스스로 멈추고(`--force` 로 넘길 수 있다), **dry-run 은 게이트에 걸려도
계획을 보여준다**(로테이션을 기다리며 미리 보려면 그래야 쓸모가 있다).
