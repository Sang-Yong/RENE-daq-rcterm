...
#    run 2466   격리됨      truncated_tail           00038
#    run 2487   격리됨      truncated_tail           00041
#    run 2547   격리됨      truncated_tail           00032
#    run 2602   격리됨      truncated_tail           00032
#    run 2614   격리됨      truncated_tail           00031
#    run 2627   격리됨      truncated_tail           00032
#    run 2651   격리됨      truncated_tail           00036
#    run 2660   격리됨      truncated_tail           00033
#    run 2664   격리됨      truncated_tail           00036
#    run 2683   격리됨      truncated_tail           00031
#    run 2957   격리됨      truncated_tail           00035
#    run 3207   격리됨      truncated_tail+prd_gap   01532,01533,01534,01535,01536,01537,01538,01539...외33개
#    run 3520   격리됨      truncated_tail+prd_gap   00570,00571,00572,00573
#    run 3523   격리됨      truncated_tail+prd_gap   00324,00325,00326
#    run 3855   격리됨      truncated_tail           00010
#    run 3923   격리됨      truncated_tail+prd_gap   00742,00743
...
#
  ...
  2466 2026-08-21 03:57:40 truncated_tail         00038                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 38 = PRD 38). 사유는 badrun/README.txt
  ...
  2487 2026-08-21 03:57:40 truncated_tail         00041                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 41 = PRD 41). 사유는 badrun/README.txt
  ...
  2547 2026-08-21 03:57:40 truncated_tail         00032                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 32 = PRD 32). 사유는 badrun/README.txt
  ...
  2602 2026-08-21 03:57:40 truncated_tail         00032                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 32 = PRD 32). 사유는 badrun/README.txt
  2604 2026-08-21 03:57:40 not_processed          -                      FADC 1 / PRD 0. 로컬에 후처리 산출물이 없다 — 후처리를 안 했거나 산출물이 이 PC 에 없다
  2614 2026-08-21 03:57:40 truncated_tail         00031                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 31 = PRD 31). 사유는 badrun/README.txt
  ...
  2627 2026-08-21 03:57:40 truncated_tail         00032                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 32 = PRD 32). 사유는 badrun/README.txt
  ...
  2651 2026-08-21 03:57:40 truncated_tail         00036                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 36 = PRD 36). 사유는 badrun/README.txt
  ...
  2660 2026-08-21 03:57:40 truncated_tail         00033                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 33 = PRD 33). 사유는 badrun/README.txt
  2664 2026-08-21 03:57:40 truncated_tail         00036                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 36 = PRD 36). 사유는 badrun/README.txt
  2683 2026-08-21 03:57:40 truncated_tail         00031                  원시 파일 2 개를 badrun/ 으로 격리했다. 나머지는 완결 (FADC 31 = PRD 31). 사유는 badrun/README.txt
  ...
  3207 2026-08-21 03:57:40 truncated_tail+prd_gap 01532,01533,01534,01535,01536,01537,01538,01539...외33개 FADC 1572 / PRD 1417. 원시 파일 2 개 격리됨(서브런 01572). 서브런 01532 01533 01534 01535 01536 01537 01538 01539 01540 01541 01542 01543 01544 01545 01546 01547 01548 01549 01550 01551 01552 01553 01554 01555 01556 01557 01558 01559 01560 01561 01562 01563 01564 01565 01566 01567 01568 01569 01570 01571 은 원본이 멀쩡하다. 재처리하면 된다; 빠진 서브런 155 개 중 뒤 40 개만 열어 봤다 (--max-check)
  ...
  3460 2026-08-21 03:57:41 prd_gap                00010                  FADC 11 / PRD 10. 서브런 00010 은 원본이 멀쩡하다. 재처리하면 된다
  ...
  3520 2026-08-21 03:57:41 truncated_tail+prd_gap 00570,00571,00572,00573 FADC 573 / PRD 570. 원시 파일 2 개 격리됨(서브런 00573). 서브런 00570 00571 00572 은 원본이 멀쩡하다. 재처리하면 된다
  3523 2026-08-21 03:57:41 truncated_tail+prd_gap 00324,00325,00326      FADC 326 / PRD 324. 원시 파일 2 개 격리됨(서브런 00326). 서브런 00324 00325 은 원본이 멀쩡하다. 재처리하면 된다
  ...
  3923 2026-08-21 03:57:41 truncated_tail+prd_gap 00742,00743            FADC 743 / PRD 742. 원시 파일 2 개 격리됨(서브런 00743). 서브런 00742 은 원본이 멀쩡하다. 재처리하면 된다
